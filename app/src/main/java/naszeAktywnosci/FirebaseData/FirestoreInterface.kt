...
interface FirestoreInterface {
    ...
    suspend fun updateMeasurement(userId: String, measurementId: String, updatedMeasurement: UserMeasurments);
    ...
    suspend fun updateMealInfo(userId: String, mealId : String, mealInfo: MealInfo)
    ...
    suspend fun updateInsulinInfo(userId:String, insulinId: String, insulinInfo: InsulinInfo)
}